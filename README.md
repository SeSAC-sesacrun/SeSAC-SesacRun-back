...
- **황병일** : 사용자 인증 (Auth)
- **최유림** : 커뮤니티 (Recruitment)
- **양수경** : 주문 & 결제 (Order & Payment)
- **김현중** : 강의 관리 (Course)

## 프로젝트 개요

> **온라인 강의 플랫폼과 학습 커뮤니티를 결합한 통합 학습 서비스**   
강사와 학습자를 연결하여 강의 수강부터
스터디·프로젝트 팀원 모집, 실시간 채팅 기반 소통까지 지원하는 플랫폼입니다.   
인프런(Infrean)과 유사한 서비스 구조를 기반으로 기능을 확장하여 구현했습니다.
...
- **커뮤니티**: 함께 공부할 동료 찾기 / WebSocket 기반 실시간 채팅
